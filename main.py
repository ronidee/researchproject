...
def reconstruct_sample(args):
    ...
    dummy_train = jnp.delete(client_train, args.target_index, axis=0)
    ...
    def diff_wrapper(_dummy_sample):#, _attack_snapshot_dir=None):
        ...
        # tree more closely.
        d = compute_tree_difference(client_tree, dummy_tree, client_train[:, -1], _dummy_train[:, -1], feature_bounds)
