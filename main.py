...
def reconstruct_sample(args):
    ...
    dummy_train = dummy_train.at[args.target_index].set(0) # delete sample to attack
    ...
    if args.dummy_state:
        ...
        if utils.ask_yes_no("Created new dummy train data. Save?"):
    ...
    def diff_wrapper(_dummy_sample, _attack_snapshot_dir=None):
        ...
        dummy_tree.fit(dummy_train.at[args.target_index].set(_dummy_sample))
